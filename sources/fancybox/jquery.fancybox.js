...
(function (window, document, $, undefined) {
	...
	$.extend(F, {
		...
		defaults: {
			...
			// HTML templates
			tpl: {
				wrap     : '<div class="fancybox-wrap" tabIndex="-1"><div class="fancybox-skin"><div class="fancybox-outer"><div class="fancybox-inner"></div><div id="timer"><span class="progress"> </span></div></div></div></div>',
				...
				next     : '<a class="fancybox-nav fancybox-next" href="javascript:void(0);"><span></span></a>',
				prev     : '<a class="fancybox-nav fancybox-prev" href="javascript:void(0);"><span></span></a>'
			},
